...
INSERT INTO amazong_products (name, price, category, image) VALUES
  ...
  ('Key to time',                   400.00, 'Clothing', 'https://time-itself.com/key.jpg'),
  ...
  ('Skin-Healing patch',            14.00, 'Clothing', null),
  ...
  ('Psychic paper',                 90.00, 'Clothing', null),
  ('Point of view gun',             145.20, 'Games', null),
  ('Unobtainium',                   50.00, 'Homeware', null),
  ('Lightsaber',                    34.50, 'Clothing', 'https://starwars.jedi/zwoom.gif'),
